...
class Appointmentschedule(models.Model):
    ...
    def _get_booking_price(self):
        for rec in self:
            ...
            if rec.coiffure_id:
                appointment_price = rec.coiffure_id.consultaion_service_id and rec.coiffure_id.consultaion_service_id.lst_price
    ...
    coiffure_id = fields.Many2one('hms.coiffure', string='coiffure', index=True)
...
class AppointmentscheduleSlot(models.Model):
    ...
    def create_appointment_slot(self, slot_date, schedule):
        ...
        slot = self.env['appointment.schedule.slot'].create({
            ...
            'coiffure_id': schedule.coiffure_id and schedule.coiffure_id.id or False,
