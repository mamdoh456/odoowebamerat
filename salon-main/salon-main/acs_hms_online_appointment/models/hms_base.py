...
class Appointment(models.Model):
    ...
    def get_slot_data(self, coiffure_id, department_id, date=False, schedule_type="appointment"):
        if date:
        ...
        if coiffure_id:
            domain += [('coiffure_id', '=', int(coiffure_id))]
        if department_id:
        ...
        for slot in slots:
            ...
            slot_data[slot.id] = {
                'date': slot.slot_date, 
                'id': slot.id, 
                'coiffure_id': slot.coiffure_id.id,
                'coiffure_name': slot.coiffure_id and slot.coiffure_id.name or '',
                'slots': slot_lines,
...
class Hmscoiffure(models.Model):
