...
class ACSMedicamentGroup(models.Model):
    ...
    coiffure_id = fields.Many2one('hms.coiffure', ondelete='set null', string='coiffure')
...
class ACSPatientMedication(models.Model):
    ...
    doctor = fields.Many2one('hms.coiffure', string='coiffure',
        help='Coiffure who prescribed the medicament')
